...
{
  private static readonly SingletonKey FloodWeatherKey = new("FloodWeather");
  private static readonly PropertyKey<int> MinDurationKey = new("MinWeatherDuration");
  private static readonly PropertyKey<int> MaxDurationKey = new("MaxWeatherDuration");
  private static readonly PropertyKey<float> HandicapMultiplierKey = new("HandicapMultiplier");
  private static readonly PropertyKey<int> HandicapCyclesKey = new("HandicapCycles");

  private static readonly PropertyKey<int> CyclesBeforeRandomizingKey = new("CyclesBeforeRandomizing");
  ...
  private void Initialize(int minDuration = 6,
                          ...
                          int cyclesBeforeRandomizingFlood = 3)
  {
    this.minDuration = minDuration;
    this.maxDuration = maxDuration;
    this.handicapMultiplier = handicapMultiplier;
    this.handicapCycles = handicapCycles;
    cyclesBeforeRandomizingFloodWeather = cyclesBeforeRandomizingFlood;
    ChanceForFlood = settings.ChanceForFlood.Value / 100.0f;
  }
